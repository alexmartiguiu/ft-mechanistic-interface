// Official Weights & Biases logo (the gold dot-matrix mark) — inline SVG so it needs no asset.
// Source: simple-icons "Weights & Biases" (natural 24×24). Rendered in the W&B brand gold.
export default function WandbLogo({ size = 16 }) {
  return (
    <svg
